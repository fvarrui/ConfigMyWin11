...
Script de configuración automática de Windows 11 (Personalizado para mi portátil)

"@

# Load functions from library
Invoke-Expression ((New-Object System.Net.WebClient).DownloadString("https://raw.githubusercontent.com/fvarrui/ConfigMyWin11/master/functions.ps1"))
